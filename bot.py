...
# Auto-bet chỉ chạy khi tín hiệu đạt ngưỡng; không có bảo đảm thắng.
MIN_CONFIDENCE_AUTO_BET = 65
...
def init_user_state(chat_id):
    ...
    if chat_id not in user_states:
        user_states[chat_id] = {
            ...
            'always_bet': False       # không ép cược khi tín hiệu yếu
        }
...
║ 📊 ĐÃ THU THẬP: {n}/20 KẾT QUẢ</pre>"""
    ...
    def on_tick_update(data):
        ...
        if (gs == 'BETTING' and st['auto_bet_enabled'] and AUTO_BET_RUN_UNTIL_STOP
                and dt >= MIN_CONFIDENCE_AUTO_BET):
            # Chỉ gửi lệnh khi điểm tín hiệu đạt ngưỡng; bỏ phiên khi tín hiệu yếu.
